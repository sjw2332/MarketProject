...
<body>
	...
	<footer id="footer">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-3 col-md-6 footer-contact">
						<h4>Contact Us</h4>
						<p>
							부산광역시 <br> 부산진구<br> 그린컴퓨터아카데미 <br> <strong>Phone:</strong>
							+1 23 456 789<br> <strong>Email:</strong> info@example.com<br>
						</p>
		...
		<div class="container">
			<div class="copyright">
				&copy; Copyright <strong>MyTube</strong>. All Rights Reserved
			</div>
